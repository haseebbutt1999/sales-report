...
//            'location_ids'=>"61573333152",
                ...
                if( isset($inventory)){
                    ...
                    $inv_save =   InventoryLocationQuantity::where('inventory_item_id',$variant->inventory_item_id)->where('status',1)->where('location_id',$inv['location_id'])->where('created_at',$updated_date)->first();
