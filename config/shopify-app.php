...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_inventory,read_products,read_all_orders, write_products, write_orders, read_orders, read_product_listings ' ),
    ...
    */
    ...
    'webhooks' => [
        [
            'topic' =>  'orders/create',
            'address' => 'https://phpstack-176572-1903902.cloudwaysapps.com/webhook/orders-create'
        ],
        [
            'topic' => 'products/create',
            'address' => 'https://phpstack-176572-1903902.cloudwaysapps.com/webhook/products-create'
        ],
        [
            'topic' => 'products/update',
            'address' => 'https://phpstack-176572-1903902.cloudwaysapps.com/webhook/products-update'
        ],
        [
