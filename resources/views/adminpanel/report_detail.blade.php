                                    ...
                                    <div class="row px-3" style="overflow-x:auto;">
                                        ...
                                        <table id="datatabled" class="table   table-hover  table-class ">
                                            ...
                                            <tr class="td-text-center ">
                                                ...
                                                <td class="total-cash-remaining"><span class="mr-1">{{$report_data->currency}}</span>{{floatval($report_data->all_credit) - floatval($report_data->comision) - (floatval($report_data->payment1) + floatval($report_data->payment2) + floatval($report_data->payment3) + floatval($report_data->payment4) + floatval($report_data->payment5))}}</td>
                                            </tr>
                                            <tr class="td-text-center ">
                                                ...
                                                <td class="d-flex w-100 justify-content-between total-cash-collected">
                                                    <div style="width: 15%;">
                                                        ...
                                                        <span class="ml-1 total-amount-collected" >{{floatval($report_data->all_credit) - floatval($report_data->comision) - (floatval($report_data->payment1) + floatval($report_data->payment2) + floatval($report_data->payment3) + floatval($report_data->payment4) + floatval($report_data->payment5))}}</span>
                                                    </div>
                                                    <div style="width: 70%;">
                                                        <span><strong>Note:</strong></span>
